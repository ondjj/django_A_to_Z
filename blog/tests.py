...
class TestView(TestCase):
    ...
    def navbar_test(self, soup):
        ...
        self.assertEqual(home_btn['href'], '/')

        blog_btn = navbar.find('a', text='Blog')
        self.assertEqual(blog_btn['href'], '/blog/')

        about_me_btn = navbar.find('a', text='About Me')
        self.assertEqual(about_me_btn['href'], '/about_me/')
    ...
    def test_post_detail(self):
        ...
        # 2.5. 첫 번째 포스트의 작성자(autor)가 포스트 영역에 있다 (아직 구현 할 수 없음)
